...
def seed():
    ...
    alex = {
        "_id": user_id,
        "profile": {"name": "Alex", "diagnosis_date": "2024-04-12", "caregiver_name": "Maya", "caregiver_relationship": "Wife"},
        "medical": {"medications": ["Aspirin 100mg", "Lisinopril 10mg", "Metformin 500mg"], "allergies": ["Penicillin"], "conditions": ["Hypertension", "Type 2 Diabetes"], "doctor_name": "Dr. Smith"},
        "preferences": {
        ...
        "routine": {"meals": {"breakfast": "08:00", "lunch": "12:30", "dinner": "18:00"}, "medications": {"morning": "08:30", "evening": "20:00"}},
        "voice_id": os.getenv("ALEX_VOICE_ID", "mock_voice_id"),
        "interface_settings": {"simplified_view": False, "show_subtitles": True, "shortcut_threshold": 5, "default_input_mode": "tree", "caregiver_panel_width": 25},
        "knowledge_score": 71,
